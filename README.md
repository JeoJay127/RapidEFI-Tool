...
## RapidEFI-v2.0.0 (基于OpenCore-v0.9.9，当前最新版本) 
...
## RapidEFI-v1.3.0 (基于OpenCore-v0.9.8)  
...
2.Bulldozer(15h) and Jaguar(16h) 主要支持比如FM1，FM2, AM3速龙系列，推土机系列(FX6300,FX8300等处理器)
...
0代(Core 2双核P8800 + GT320M)老笔记本【ASUS-K40ID】

OpenCore-v0.9.8 模拟UEFI 安装macOS BigSur 11.7.7
理论支持macOS Sonoma 14.x (配置比较老，粉丝也不想折腾更高版本了)

![Laptop-Core2-P8800](images/Laptop-Core2-P8800.png)

1代老笔记本【Aspire 3820ZG】
